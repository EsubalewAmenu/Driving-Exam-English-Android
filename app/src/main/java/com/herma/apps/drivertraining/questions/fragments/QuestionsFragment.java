...
db.close();
    int seenPer = 100-((unseen*100)/countAll);
        ...
        doneQuestions.setText("Overall progress ፡ " + seenPer + "%");
        percentAnsQue.setText("Overall answered ፡ " + totPerc + "%");
...
//        youtubeEmbeded();
    ...
    public void examResult(){
        ...
        txtScore.setText("Result : " + score+"/"+answerKey.length + " (" + perc + "%) " + rank+"\nTime :- "+ timer);
        if(perc <74)
